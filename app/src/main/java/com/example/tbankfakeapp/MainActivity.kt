        ...
        setContent {
            TBankAppTheme {
                ...
                Scaffold(
                    ...
                    bottomBar = {
                        BottomNavigation(navController = navController, onNavigate = { /* optional callback */ })
                    }
                    ...
                    NavHost(
                        ...
                        modifier = Modifier.fillMaxSize(),
                        builder = {
                            composable("main_screen") { MainScreen(innerPadding) }
                            composable("payments_screen") { PaymentsScreen(innerPadding) }
                            composable("city_screen") { CityScreen(innerPadding) }
                            composable("chat_screen") { ChatScreen(innerPadding) }
                            composable("hub_screen") { HubScreen(innerPadding) }
                        }
                    )
                }
            }
